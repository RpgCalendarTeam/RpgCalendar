...
export class AccountComponent implements OnInit{
    ...
    headers: string[];
  constructor(private userService: UserService, private itemService: ItemService, public dialog: MatDialog) {
    this.headers = ['ID','Name', 'Description', 'Quantity', 'Quality', 'Option'];
  }
  ...
  deleteItem(itemID: number): void{
    this.itemService.DeleteItem(itemID).subscribe(() => (this.initItems(this.user)));
  }
